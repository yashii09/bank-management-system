...
public class SignupThree extends JFrame implements ActionListener{
    ...
    JRadioButton savingAccount, fdAccount, currentAccount, recurringAccount;
    ...
    SignupThree(String formno){
        ...
        fdAccount.setBounds(350, 180, 200, 20);
        add(fdAccount);
        ...
        recurringAccount.setBounds(350, 220, 200, 20);
        ...
        c7 = new JCheckBox("I hereby declares that the above enters details are correct to the best of my knowledge");
